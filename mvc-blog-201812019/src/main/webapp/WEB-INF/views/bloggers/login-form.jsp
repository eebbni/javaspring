      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="../bloggers/login">
			<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %> 
			<%
				String hostContext = request.getScheme( ) + "://" + request.getServerName() 
						+ ":" + request.getServerPort() + request.getContextPath().toString();
				String uri = request.getHeader("referer").substring(hostContext.length());
			...
			--%>  
	          ...
	          <div class="form-label-group">
                <input type="text" name="bid" id="inputId" class="form-control" placeholder="ID" required >
